...
DECLARE_MODULE(drmn_old, drm_mod, SI_SUB_DRIVERS, SI_ORDER_FIRST);
MODULE_VERSION(drmn_old, 1);
MODULE_DEPEND(drmn_old, agp, 1, 1, 1);
MODULE_DEPEND(drmn_old, pci, 1, 1, 1);
MODULE_DEPEND(drmn_old, mem, 1, 1, 1);
MODULE_DEPEND(drmn_old, iicbus, 1, 1, 1);
